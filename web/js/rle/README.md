...
docker run \
  ...
  -u $(id -u):$(id -g) \
  emscripten/emsdk \
  emcc ms-rle.c -g -s EXPORTED_FUNCTIONS="['_RleDecompressAndFlipAndRGBA', '_malloc', '_free']" -sALLOW_MEMORY_GROWTH -sEXPORTED_RUNTIME_METHODS=ccall -O0 -o ms-rle-wasm.js
```
